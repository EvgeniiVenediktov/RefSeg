...
def get_parser():
    parser = argparse.ArgumentParser(description='METRIS training and testing')
    ...
    parser.add_argument('--model', default='metris', help='model: metris')
    parser.add_argument('--model_id', default='metris', help='name to identify the model')
    ...
    parser.add_argument('--refer_data_root', default='/database/dataset/', help='REFER dataset root directory')
